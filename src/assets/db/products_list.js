    ...
    images: {
      ...
      variants: {
        ...
        blue: {
          color: "blue",
          images: [
            { src: "/src/assets/img/adidas1_blue.avif", alt: "Product Image 1" },
            { src: "/src/assets/img/adidas2_blue.avif", alt: "Product Image 2" },
            { src: "/src/assets/img/adidas3_blue.avif", alt: "Product Image 3" },
            { src: "/src/assets/img/adidas4_blue.avif", alt: "Product Image 4" },
            { src: "/src/assets/img/adidas5_blue.avif", alt: "Product Image 5" },
            { src: "/src/assets/img/adidas6_blue.avif", alt: "Product Image 6" },
            { src: "/src/assets/img/adidas7_blue.avif", alt: "Product Image 7" },
            { src: "/src/assets/img/adidas8_blue.avif", alt: "Product Image 8" },
            { src: "/src/assets/img/adidas9_blue.avif", alt: "Product Image 9" },
          ],
        },
        green: {
          color: "green",
          images: [
            { src: "/src/assets/img/adidas1_green.avif", alt: "Product Image 1" },
            { src: "/src/assets/img/adidas2_green.avif", alt: "Product Image 2" },
            { src: "/src/assets/img/adidas3_green.avif", alt: "Product Image 3" },
            { src: "/src/assets/img/adidas4_green.avif", alt: "Product Image 4" },
            { src: "/src/assets/img/adidas5_green.avif", alt: "Product Image 5" },
            { src: "/src/assets/img/adidas6_green.avif", alt: "Product Image 6" },
            { src: "/src/assets/img/adidas7_green.avif", alt: "Product Image 7" },
            { src: "/src/assets/img/adidas8_green.avif", alt: "Product Image 8" },
            { src: "/src/assets/img/adidas9_green.avif", alt: "Product Image 9" },
          ],
        },
      },
    },
